...
function runsim(simnum, ip::ModelParameters)
    ...
    age_groups = [0:4, 5:10, 11:13, 14:17, 18:20, 21:29, 30:39, 40:49, 50:64, 65:999]
    ...
    insertcols!(ag9, 1, :sim => simnum);insertcols!(ag10, 1, :sim => simnum); insertcols!(work, 1, :sim => simnum);
...
function main(ip::ModelParameters,sim::Int64)
    ...
    #keep vaccinating with the baseline rate up to the end of simulation
    ...
    # We do not care about this part anymore
    # I am keeping that just for convenience
    for x in humans
