...
run_param_scen_cal(false,0.109,"usa",10,50,1,1,1,1,1,92,999,194,7,446,3,2,14,rc,dc,852,true,999,1,1,0.0,1.2,false)
run_param_scen_cal(false,0.109,"usa",10,50,1,1,1,1,1,92,999,194,7,446,3,2,14,rc,dc,852,true,999,1,1,0.2,1.0,false)
...
run_param_scen_cal(false,0.109,"usa",10,50,1,1,1,1,1,92,999,194,7,446,4,2,14,rc,dc,852,true,999,1,1,0.0,1.2,true)
run_param_scen_cal(false,0.109,"usa",10,50,1,1,1,1,1,92,999,194,7,446,4,2,14,rc,dc,852,true,999,1,1,0.2,1.0,true)
...
dc = [1;map(y->75+y,0:(6));map(y->128+y,0:14);map(y->177+y,0:27);map(y-> 220+y,0:34);map(y->292+y,0:14);map(y->336+y,0:52);map(y->417+y,0:15)]#;map(y->122+y,0:15)]
rc = [1.0;map(y->1.0-(0.08/7)*y,1:7);map(y->0.92-(0.10/15)*y,1:15);map(y-> 0.82+(0.07/28)*y,1:28);map(y-> 0.89-(0.205/35)*y,1:35);map(y-> 0.685+(0.15/15)*y,1:15);map(y-> 0.835-(0.17/53)*y,1:53);map(y-> 0.665+(0.036/16)*y,1:16)]#;map(y->0.92-(0.085/16)*y,1:16)]
run_param_scen_cal(false,0.109,"usa",10,50,1,1,1,1,1,92,999,194,7,446,7,2,14,rc,dc,852,true,999,1,1,0.2,1.2,true)
...
run_param_scen_cal(true,0.106,"usa",10,50,1,1,1,1,1,92,999,194,7,999,1,2,14,rc,dc,456,true,999,1,1)
